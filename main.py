from functions import find_middle_red_zone_point, generate_complete_path, generate_waypoints, get_points_around_middle_point, haversine, in_red_zone, meters_to_degrees, plot_path, point_with_bearing
...
def main():
    ...
    middle_red_zone_point = find_middle_red_zone_point(path, redzones)
